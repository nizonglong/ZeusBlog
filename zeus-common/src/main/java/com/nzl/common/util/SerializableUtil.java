 ...
 * @desc: Serializable工具(JDK)(也可以使用Protobuf)
 * @version: 0.1
 **/
@NoArgsConstructor
public class SerializableUtil {
    ...
    public static byte[] serializable(Object object) {
        ...
        try {
            ...
            throw new ZeusException("SerializableUtil工具类序列化出现IOException异常:" + e.getMessage());
        } finally {
            try {
                if (oos != null) {
                    oos.close();
                ...
                throw new ZeusException("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage());
            }
        }
    }
    ...
    public static Object unserializable(byte[] bytes) {
        ...
        try {
            ...
            throw new ZeusException("SerializableUtil工具类反序列化出现ClassNotFoundException异常:" + e.getMessage());
        } catch (IOException e) {
            logger.error("SerializableUtil工具类反序列化出现IOException异常:{}", e.getMessage());
            throw new ZeusException("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage());
        } finally {
