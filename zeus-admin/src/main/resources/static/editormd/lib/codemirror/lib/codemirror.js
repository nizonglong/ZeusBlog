...
(function(mod) {
  ...
  CodeMirror.fromTextArea = function(textarea, options) {
    ...
    if (textarea.article_edit) {
      on(textarea.article_edit, "submit", save);
      // Deplorable hack to make the submit method do the right thing.
      if (!options.leaveSubmitMethodAlone) {
        var form = textarea.article_edit, realSubmit = form.submit;
        try {
    ...
    options.finishInit = function(cm) {
      ...
      cm.toTextArea = function() {
        ...
        if (textarea.article_edit) {
          off(textarea.article_edit, "submit", save);
          if (typeof textarea.article_edit.submit == "function")
            textarea.article_edit.submit = realSubmit;
        }
      };
    };
